...
import { getColumns } from "./TableDataUM"

export default function UnitsMeasurement({ darkMode }) {

    // Agregar validación de props
    UnitsMeasurement.propTypes = {
    ...
    const handleAdd = () => {
        navigate("/units-measurement/register");
    };
            ...
            <div className="flex justify-between items-center mb-1 mt-4 mr-4">
                ...
                <div>
                    ...
                    <Typography variant="paragraph" className={`mb-2 ${subTextColor}`}>
                        Administra las unidades de medida para sistemas de medicion
                    </Typography>
                </div>
