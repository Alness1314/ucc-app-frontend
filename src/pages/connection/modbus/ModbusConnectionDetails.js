...
export default function ModbusConnectionDetails({ darkMode }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                console.error("Error fetching modbus connection data:", error);
            }
        };
    ...
    const fieldsToDisplay = [
        ...
        { label: "Device - ID / Slave", key: "deviceIdSlave" },
        { label: "Direccion IP", key: "ipAddress" },
        { label: "Puerto", key: "servicePort" },
        { label: "Tasa de baudios", key: "baudRate" },
        { label: "Longitud de termino", key: "wordLength" },
        { label: "Paridad", key: "parity" },
        { label: "Detener Bit", key: "stopBit" },
        { label: "Tiempo de escaneo", key: "scanTime" },
        { label: "Tiempo de espera", key: "slaveResponseTimeOut" },
        { label: "Tipo de medio", key: "mediaType" },
        { label: "Protocolo", key: "protocol" },
        { label: "Modo de transmision", key: "transmissionMode" },
        { label: "Registro unico", key: "singleReg", format: (value) => (value ? "Activo" : "Inactivo") },
        { label: "Estado", key: "status", format: (value) => (value ? "Activo" : "Inactivo") },
    ...
    const breadcrumbsPaths = [
        ...
        {
            name: "Detalle",
            route: `/modbus/details/${connectionId}`,
        },
    ];
