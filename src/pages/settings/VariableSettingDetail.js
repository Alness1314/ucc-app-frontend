...
export default function ValueSettingDetail({ darkMode }) {
    ValueSettingDetail.propTypes = {
    ...
    useEffect(() => {
        const fetchData = async () => {
            apiService.get(`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_API_PREFIX}/global-settings/${id}`, null, true)
                .then(response => {
    ...
    const breadcrumbsPaths = [
        ...
        {
            name: "Detalle",
            route: `/global-variables/details/${id}`,
        },
    ];
            ...
            <div className="flex justify-between items-center mb-1 mt-4 mr-4">
                ...
                <div>
                    ...
                    <Typography variant="paragraph" className={`mb-2 ${subTextColor}`}>
                        Detalle de la variable de configuracion
                    </Typography>
                </div>
            </div>
