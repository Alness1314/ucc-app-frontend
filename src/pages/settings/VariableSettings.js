...
import { getColumns } from "./TableDataSettings"
...
export default function VariableSettings({ darkMode }) {
    ...
    const fetchData = async () => {
        apiService.get(`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_API_PREFIX}/global-settings`, null, true)
            .then(response => {
    ...
    const handleDetails = (id) => {
        navigate(`/global-variables/details/${id}`);
    };

    const handleUpdate = (id) => {
        navigate(`/global-variables/edit/${id}`);
    };
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            apiService.delete(`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_API_PREFIX}/global-settings/${id}`, true)
                .then(response => {
    ...
    const handleAdd = () => {
        navigate("/global-variables/register");
    };
